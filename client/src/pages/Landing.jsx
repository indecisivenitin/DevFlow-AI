...
//       {/* Background Glow */}
//       <div className="absolute inset-0 -z-10">
//         <div className="absolute w-[600px] h-[600px] bg-indigo-500/30 blur-3xl rounded-full top-[-120px] left-[-120px]" />
//         <div className="absolute w-[500px] h-[500px] bg-purple-500/30 blur-3xl rounded-full bottom-[-120px] right-[-120px]" />
//       </div>
...
//         <p className="text-gray-300 mt-6 text-base md:text-lg max-w-3xl mx-auto leading-relaxed">
//           DevFlow AI is a real-time developer productivity workspace engineered to
//           eliminate context switching, reduce cognitive overload, and help developers
//           think with clarity. Instead of juggling between documentation, tutorials,
//           forums, and endless browser tabs, you get structured, streaming AI insights
//           directly inside a clean, distraction-free environment designed for modern
//           engineers.
//         </p>

//         <Link
//           to="/register"
//           className="mt-8 inline-block px-8 py-4 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-2xl hover:scale-105 transition shadow-lg"
//         >
//           Start Building Smarter
//         </Link>
//       </section>
...
//             icon={<Zap size={26} />}
//             title="Instant Debugging"
//             text="Get deep, structured explanations for errors, stack traces, and unexpected behavior. Understand not just the fix — but the reasoning behind it."
//           />
//           <Feature
//             icon={<Brain size={26} />}
//             title="Smarter Thinking"
//             text="Break complex topics like React internals, system design, or backend architecture into clean mental models that improve long-term understanding."
//           />
//           <Feature
//             icon={<Clock size={26} />}
//             title="Save Hours Weekly"
//             text="Reduce unnecessary Googling and context switching. DevFlow keeps your workflow focused, fast, and intelligently assisted."
//           />
//         </div>
//       </section>

//       {/* WORKFLOW */}
//       <section className="px-6 md:px-8 py-20 bg-white/5 backdrop-blur-lg">
//         <div className="max-w-6xl mx-auto text-center">
...
//               number="01"
//               title="Provide Context"
//               text="Share your code, architecture decisions, or technical doubts. DevFlow maintains conversational memory to keep responses contextual."
//             />
//             <WorkflowStep
//               number="02"
//               title="Stream Structured Insights"
//               text="Receive formatted, real-time responses with code blocks, structured explanations, and practical examples."
//             />
//             <WorkflowStep
//               number="03"
//               title="Implement Confidently"
//               text="Apply fixes and improvements instantly. Move from confusion to clarity in minutes, not hours."
//             />
//           </div>
//         </div>
//       </section>
...
//           <p className="text-gray-300 leading-relaxed max-w-3xl mx-auto">
//             DevFlow AI was architected and developed by
//             <span className="text-white font-semibold"> Nitin Yadav</span>,
//             a full-stack developer focused on building scalable, production-ready
//             AI systems. With hands-on experience across React, Node.js, MongoDB,
//             backend API design, real-time streaming architectures, and containerized
//             deployments using Docker, the goal is to build tools that genuinely improve
//             developer workflow.
//           </p>

//           <p className="text-gray-400 mt-8 leading-relaxed max-w-3xl mx-auto">
//             The focus behind DevFlow is practical engineering — reducing debugging friction,
//             improving context clarity, and delivering structured AI assistance directly
//             inside the development lifecycle.
//           </p>
